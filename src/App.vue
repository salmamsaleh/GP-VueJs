<template>
  ...
  >
    <!-- BEGIN: Content-->
    <Sidebar v-if="!$route.meta.hideNavigation"></Sidebar>
    
    <div class="app-content content" v-if="!$route.meta.hideNavigation">
      <Navbar></Navbar>
...
.main-menu .navbar-header .navbar-brand .brand-logo {
  background: url("assets/images/vuesax-logo.png") no-repeat;
...
.main-menu .navbar-header .navbar-brand .brand-text {
  ...
  -webkit-animation: 0.3s cubic-bezier(0.25, 0.8, 0.25, 1) 0s normal forwards 1
    fadein;
  -moz-animation: 0.3s cubic-bezier(0.25, 0.8, 0.25, 1) 0s normal forwards 1
    fadein;
  -o-animation: 0.3s cubic-bezier(0.25, 0.8, 0.25, 1) 0s normal forwards 1
    fadein;
...
div.dataTables_wrapper div.dataTables_length select {
  background-position: -webkit-calc(100% - 3px) 5px,
    -webkit-calc(100% - 20px) 13px, 100% 0;
  background-position: -moz-calc(100% - 3px) 5px, -moz-calc(100% - 20px) 13px,
    100% 0;
...
a.nav-link.modern-nav-toggle.pr-0 {
    margin-top: 0.5em;
}
</style>
