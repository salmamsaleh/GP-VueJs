                ...
                <div class="chat-profile-sidebar">
                    <header class="chat-profile-header">
                        ...
                        <div class="header-profile-sidebar">
                            <div class="avatar">
                                <img src="../../assets/images/avatar-s-11.png" alt="user_avatar" height="70" width="70">
                ...
                <div class="sidebar-content card">
                    ...
                    <div class="chat-fixed-search">
                        <div class="d-flex align-items-center">
                            <div class="sidebar-profile-toggle position-relative d-inline-flex">
                                <div class="avatar">
                                    <img src="../../assets/images/avatar-s-11.png" alt="user_avatar" height="40" width="40">
                    ...
                    <div id="users-list" class="chat-user-list list-group position-relative">
                        ...
                        <ul class="chat-users-list-wrapper media-list">
                            <li>
                                <div class="pr-1">
                                    <span class="avatar m-0 avatar-md"><img class="media-object rounded-circle" src="../../assets/images/avatar-s-3.png" height="42" width="42" alt="Generic placeholder image">
                                        <i></i>
                                    </span>
                                </div>
                            ...
                            <li>
                                <div class="pr-1">
                                    <span class="avatar m-0 avatar-md"><img class="media-object rounded-circle" src="../../assets/images/avatar-s-7.png" height="42" width="42" alt="Generic placeholder image">
                                        <i></i>
                                    </span>
                                </div>
                                <div class="user-chat-info">
                        ...
                        <ul class="chat-users-list-wrapper media-list">
                            <li>
                                <div class="pr-1">
                                    <span class="avatar m-0 avatar-md"><img class="media-object rounded-circle" src="../../assets/images/avatar-s-8.png" height="42" width="42" alt="Generic placeholder image">
                                        <i></i>
                                    </span>
                                </div>
                                <div class="user-chat-info">
                            ...
                            <li>
                                <div class="pr-1">
                                    <span class="avatar m-0 avatar-md"><img class="media-object rounded-circle" src="../../assets/images/avatar-s-5.png" height="42" width="42" alt="Generic placeholder image">
                                        <i></i>
                                    </span>
                                </div>
                                <div class="user-chat-info">
                            ...
                            <li>
                                <div class="pr-1">
                                    <span class="avatar m-0 avatar-md"><img class="media-object rounded-circle" src="../../assets/images/avatar-s-9.png" height="42" width="42" alt="Generic placeholder image">
                                        <i></i>
                                    </span>
                                </div>
                                <div class="user-chat-info">
                            ...
                            <li>
                                <div class="pr-1">
                                    <span class="avatar m-0 avatar-md"><img class="media-object rounded-circle" src="../../assets/images/avatar-s-14.png" height="42" width="42" alt="Generic placeholder image">
                                        <i></i>
                                    </span>
                                </div>
                                <div class="user-chat-info">
                ...
                <div class="content-body">
                                ...
                                <header class="chat_header d-flex justify-content-between align-items-center p-1">
                                    <div class="vs-con-items d-flex align-items-center">
                                        ...
                                        <div class="avatar user-profile-toggle m-0 m-0 mr-1">
                                            <img src="../../assets/images/avatar-s-1.png" alt="" height="40" width="40" />
                                    ...
                                    <div class="chat">
                                        <div class="chat-avatar">
                                            <a class="avatar m-0" data-toggle="tooltip" href="#" data-placement="right" title="" data-original-title="">
                                                <img src="../../assets/images/avatar-s-1.png" alt="avatar" height="40" width="40" />
                                            </a>
                                        </div>
                                        <div class="chat-body">
                                    ...
                                    <div class="chat chat-left">
                                        <div class="chat-avatar">
                                            <a class="avatar m-0" data-toggle="tooltip" href="#" data-placement="left" title="" data-original-title="">
                                                <img src="../../assets/images/avatar-s-7.png" alt="avatar" height="40" width="40" />
                                            </a>
                                        </div>
                                        <div class="chat-body">
                                            <div class="chat-content">
                    ...
                    <div class="user-profile-sidebar">
                        <header class="user-profile-header">
                            ...
                            <div class="header-profile-sidebar">
                                <div class="avatar">
                                    <img src="../../assets/images/avatar-s-1.png" alt="user_avatar" height="70" width="70">
